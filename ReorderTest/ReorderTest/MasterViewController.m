...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    if ([[_objects objectAtIndex:indexPath.row] isKindOfClass:[NSString class]] &&
        ...
        // You must setup the view you want to trigger the gesture (pan or long press) to work.
        // It is handy to trigger the event from any UIView in your cell or just entire cell like the sample below.
        [self.reorderTableView addLongPressGestureRecognizerToTargetView:cell.contentView];
    }
